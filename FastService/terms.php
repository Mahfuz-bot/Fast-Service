...
<body>
   ...
   <div class="container">
      ...
      <p>
         The fastservice website located at fastservice.dummy is a
         copyrighted work belonging to FAST SERVICE. Certain features of the
      ...
      <p>
         ...
         fastservice uses ‘cookies’. These cookies are used to store
      ...
      <p>
         ...
         use of the Site in violation of these Terms.  Upon termination of
      ...
      <ul>
         ...
         <li>
            ...
            and under penalty of perjury, that you are either the owner of
      ...
      <p>
         ...
         Notice to the Company should be sent to: Malibagh, Dhaka, BD. After
      ...
      <p>
         ...
         Terms.  The AAA Consumer Arbitration Rules governing the arbitration
      ...
      <p>
         ...
         all or part of any claim.  The arbitrator shall have the authority
         to award monetary damages, and to grant any non-monetary remedy or
         relief available to an individual under applicable law, the AAA
         Rules, and the Terms.  The arbitrator shall issue a written award
